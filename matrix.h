/*
  ...
  Karl Zeilhofer
	...
	19.6.2011
		Copy Construktor hinzugef�gt, f�r tiefe speicher kopie
		Copy Assignment Operator implementiert

	20.6.2011
		Um dem Speicherleck auf die Spur zu kommen, wurden alle
			Methoden auf Pass und Return by Value ge�ndert. Brachte leider keine Verbesserung.
		Zugriff durch nur einen Index f�r den ()-Operator
			zB A(1)=5;
   ...
   TODOs:
		...
		Dynamisches vergr��ern der matrix

		Speicherleck stopfen!
		Exceptions einf�hren
