...
COMPRESS      = gzip -9f
DISTNAME      = 1.0.0
DISTDIR = /home/karl/Qt4-projects/CopperField_UTF/.tmp/1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
SOURCES       = crosshair.cpp \
		...
		matrix.cpp qrc_copperfield.cpp \
		moc_view.cpp \
		moc_copperfield.cpp \
...
$(TARGET): ui_gcodesettings.h ui_dialoglayers.h ui_layerwidget.h ui_progresssplashscreen.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents crosshair.h griditem.h scene.h ui_copperfield.h view.h copperfield.h gerberreader.h gerberaperture.h netsviewer.h gcodesettings.h netlistwidget.h dialoglayers.h gerberelement.h layerwidget.h progresssplashscreen.h matrix.h $(DISTDIR)/
	$(COPY_FILE) --parents crosshair.cpp cutout.cpp griditem.cpp main.cpp scene.cpp view.cpp copperfield.cpp gerberreader.cpp gerberaperture.cpp netsviewer.cpp gcodesettings.cpp netlistwidget.cpp dialoglayers.cpp gerberelement.cpp layerwidget.cpp progresssplashscreen.cpp matrix.cpp $(DISTDIR)/
	$(COPY_FILE) --parents gcodesettings.ui dialoglayers.ui layerwidget.ui progresssplashscreen.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_view.cpp moc_copperfield.cpp moc_gerberreader.cpp moc_netsviewer.cpp moc_gcodesettings.cpp moc_netlistwidget.cpp moc_dialoglayers.cpp moc_layerwidget.cpp moc_progresssplashscreen.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_view.cpp moc_copperfield.cpp moc_gerberreader.cpp moc_netsviewer.cpp moc_gcodesettings.cpp moc_netlistwidget.cpp moc_dialoglayers.cpp moc_layerwidget.cpp moc_progresssplashscreen.cpp
moc_view.cpp: view.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/home/karl/Qt4-projects/CopperField_UTF -I/home/karl/Qt4-projects/CopperField_UTF -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtOpenGL -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include view.h -o moc_view.cpp
...
compiler_uic_make_all: ui_gcodesettings.h ui_dialoglayers.h ui_layerwidget.h ui_progresssplashscreen.h
compiler_uic_clean:
	-$(DEL_FILE) ui_gcodesettings.h ui_dialoglayers.h ui_layerwidget.h ui_progresssplashscreen.h
ui_gcodesettings.h: gcodesettings.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gcodesettings.ui -o ui_gcodesettings.h

ui_dialoglayers.h: dialoglayers.ui \
		layerwidget.h \
		gerberreader.h \
		gerberaperture.h \
		gerberelement.h \
		gcodesettings.h \
		matrix.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic dialoglayers.ui -o ui_dialoglayers.h

ui_layerwidget.h: layerwidget.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic layerwidget.ui -o ui_layerwidget.h

ui_progresssplashscreen.h: progresssplashscreen.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic progresssplashscreen.ui -o ui_progresssplashscreen.h
