...
Matrix Matrix::inv()
{
	...
	// TODO: �berpr�fungen auf NULL
	// �berpr�fen auf quadatisch
	// zus�tzlichen speicher reservieren f�r die einheitsmatrix rechts.

	double **a; // speicher f�r die beiden matrizzen (originale und inverse)
	...
	// Speicher anlgen, der f�r beide Matrizen Plaz hat.
	a = new double*[n];
	...
	if (fehler)
	{
		std::cout << ("Inverse: Matrix ist fast singul�r oder singul�r\n");
		return Matrix();
	}
